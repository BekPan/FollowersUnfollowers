...
with sync_playwright() as p:
    ...
    page.goto('https://www.instagram.com/accounts/login/?hl=el')
    page.get_by_role("button", name="Απόρριψη προαιρετικών cookies").click()
    ...
    page.get_by_role("button", name="Όχι τώρα").click()
    page.get_by_role("button", name="Όχι τώρα").click()
    user="Εικόνα προφίλ του χρήστη"+" "+username+" "+"Προφίλ"
    page.get_by_role("link", name=user).click()
    page.get_by_role("link", name="ακόλουθοι").click()
    ...
    while f1 < int(followers) :
        ...
        row1 += 1
        f1 += 1
    page.get_by_role("button", name="Κλείσιμο").click()

    page.get_by_role("link", name="Ακολουθείτε").click()
    f2 = 0
    row2 = 2
    ...
    page.get_by_role("link", name="Ρυθμίσεις Περισσότερα").click()
    page.get_by_role("button", name="Αποσύνδεση").click()

    sheet["C1"] = "Not Following" #=FILTER(A2:A;COUNTIF(B2:B;A2:)=0)
    sheet["D1"] = "Not Followers" #=FILTER(B2:B;COUNTIF(A2:A;B2:B)=0)
